...
public sealed record EgressPoolOptions
{
    ...
    /// </summary>
    public required IReadOnlyList<IPNetwork> Prefixes { get; init; }

    /// <summary>
    /// Gets the mode used to make selected source addresses bindable.
    /// </summary>
    public EgressAddressMode AddressMode { get; init; } = EgressAddressMode.NonLocalBind;

    /// <summary>
    /// Gets the mode used to choose a network interface.
    /// </summary>
    public EgressInterfaceSelectionMode InterfaceSelectionMode { get; init; } = EgressInterfaceSelectionMode.DefaultRoute;
    ...
    /// </summary>
    public Func<EgressInterfaceSelectionContext, string>? SelectInterface { get; init; }
    ...
    /// </summary>
    public AddressFamily? DefaultAddressFamily { get; init; }
    ...
    /// </summary>
    public bool ManageLocalRoutes { get; init; } = true;

    /// <summary>
    /// Gets the interface name used for managed local routes.
    /// </summary>
    public string LocalRouteInterfaceName { get; init; } = "lo";

    /// <summary>
    /// Gets cleanup options for network state created by the pool.
    /// </summary>
    public EgressCleanupOptions Cleanup { get; init; } = new();
}
